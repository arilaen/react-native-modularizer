...
const DEFAULT_BUILD_TYPES_BLOCK = `
        debug {
          ...
          resValue "string", "HomeTurfCodePushDeploymentKey", '""'
          resValue "string", "HomeTurfInstabugId", '"6da660c42b1e6617866ae4372cb59833"'
          resValue "string", "HomeTurfBugSnagKey", '"ddb9687e14585b5032ca599b8c35daba"'
        }
        ...
        release {
          ...
          resValue 'string', 'HomeTurfCodePushDeploymentKey', '"oK49WHWPFid38SDcl9cqFekYR9Mie8Xmpw5_U"'
          resValue "string", "HomeTurfInstabugId", '"5ec9e298933a520b50e2463da7ac3760"'
          resValue "string", "HomeTurfBugSnagKey", '"ddb9687e14585b5032ca599b8c35daba"'
        }
`;
...
export const DEFAULT_ANDROID_LIB_GRADLE_DATA = {
  ...
  groupId: 'com.org.module'
}

export const DEFAULT_ANDROID_APP_GRADLE_DATA = DEFAULT_ANDROID_LIB_GRADLE_DATA;
...
export const DEFAULT_LIB_ACTIVITY_DATA = {
  moduleName: DEFAULT_MODULE_NAME,
  imports: [],
  manualImports: [],
  packageInstances: [],
  ...
  beforeOnCreate: [],
  jsBundleFilePathStaging: "'assets://index.jsbundle'",
  jsBundleFilePathRelease: "'assets://index.jsbundle'",
  reactAppName: "app",
  groupId: 'com.org.module'
}

export const DEFAULT_APP_ACTIVITY_DATA = {
  moduleName: DEFAULT_MODULE_NAME,
  groupId: 'com.org.module'
}
