let fs,CONFIG_FILE_NAME;_eaa‍.x([["default",()=>initialize]]);_eaa‍.w("fs-extra",[["default",["fs"],function(v){fs=v}]]);_eaa‍.w("./config",[["CONFIG_FILE_NAME",["CONFIG_FILE_NAME"],function(v){CONFIG_FILE_NAME=v}]]);
  ...
  if (err) {
    _eaa‍.g.console.warn({err}); // File does not exist - TODO: Remove
